...
//		rolesForUser.add(role_guest);
		...
		userService.saveTestUser(new User("admin", "admin", "Oleg", "Petrov", "ivan@mail.com", setAdmin));
		userService.saveTestUser(new User("user", "user", "Petr", "Ivanov", "petr@mail.com", setUser));
	}
